...
assetsConfigFormFields config =
    ...
    <div class="mb-3">
        <label class="form-label">Base URL (.../rest/assets/latest)</label>
    ...
    <div class="mb-3">
        <label class="form-label">Jira email env var (basic auth)</label>
    ...
    <div class="mb-3">
        <label class="form-label">Default schema name (AQL objectSchema = "...")</label>
        <input name="defaultSchemaName" type="text" class="form-control" value={field (.defaultSchemaName)} data-testid="assets-config-schema"/>
    </div>
    <div class="mb-3">
        <label class="form-label">Host query template (AQL with {"{host}" :: Text} placeholder)</label>
    ...
    <div class="mb-3">
        <label class="form-label">Attribute display list (comma-separated)</label>
